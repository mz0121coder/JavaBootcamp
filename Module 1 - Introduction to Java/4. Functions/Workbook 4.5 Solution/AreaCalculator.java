public class AreaCalculator {
     ...
     * 
     *         Inside the function:
     *         1. If the side is negative, print "Error: impossible" and terminate
     *         the java program.
     ...
     * 
     *         Inside the function:
     *         1. If the length OR width is negative, print "Error: impossible" and
     ...
     * 
     *         Inside the function:
     *         1. If the base OR height is negative, print "Error: impossible" and
     *         terminate the program.
